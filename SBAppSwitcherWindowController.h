...
@class UIViewController, NSString, SBWindow, NSMutableSet, SBAppSwitcherWindow;

__attribute__((visibility("hidden")))
@interface SBAppSwitcherWindowController : XXUnknownSuperclass <SBUIActiveOrientationObserver> {
