...
@class SBFolderControllerAnimationContext, SBIcon, NSString, _UILegibilitySettings, SBIconViewMap, NSArray, NSTimer, SBIconAnimator, SBFolder, SBFolderView, SBFolderContext, NSMapTable;
