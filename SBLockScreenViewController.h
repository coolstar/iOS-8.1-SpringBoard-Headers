...
@class NSString, SBLockScreenFullscreenBulletinViewController, MPUSystemMediaControlsViewController, SBLockScreenEmergencyCallViewController, SBLockScreenSlideUpToAppController, SBLockScreenModalAlertViewController, SBLockScreenNowPlayingPluginController, SBLockScreenPluginController, SBLockScreenDateViewController, NSMutableArray, SBDisableAppStatusBarUserInteractionChangesAssertion, SBLockScreenHintManager, SBLockScreenResetRestoreViewController, SBLockScreenBatteryChargingViewController, SBLockScreenInfoOverlayViewController, SBLockScreenNotificationListController, SBLockScreenStatusTextViewController, SBLockScreenTimerViewController, SBLockOverlayContext, SBLockScreenDeviceBlockViewController, SBLockScreenTemperatureWarningViewController, SBLockScreenPasscodeOverlayViewController, SBLockScreenActionContext, SBLockScreenBuddyViewController;
